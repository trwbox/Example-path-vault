...
// Construct graph
var options =  export {=export nodes:=export shape:=export color:=? #003d7a : #dee2e6, export font:=export face:=export color:=? #c9cdd1 : #616469, export strokeColor:=? #c9cdd1 : #616469, export },=export scaling:=export label:=export enabled:=export },=export },=export },=export edges:=export color:=inherit: both }, export width:=export smooth:=export type:=export },=export hoverWidth:=export },=export interaction:=export hover:=export },=export height:=export width:=export physics:=export solver:=export minVelocity:=export },=export }=export =;
